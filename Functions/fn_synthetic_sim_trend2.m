%SYNTHETIC SIMULATION OF TREND SURFACE - WITH OUTPUT MASK

%JCC 16072013

function [ZI_piece,xx_piece,yy_piece,mask]=fn_synthetic_sim_trend2(csLeft,csRight,mesh_info)
...
yPolyClip=[bottomLeft(2,1) topLeft(2,1) top(2,:) topRight(2,1) bottomRight(2,1) fliplr(bottom(2,:)) bottomLeft(2,1)];
...
[ZI,mask]=fn_synthetic_mask_grid2(ZI,xx,yy,xPolyClip,yPolyClip);
