%SYNTHETIC SIMULATION OF TREND SURFACE - WITHOUT MASK OUTPUT

%JCC 16072013


function [ZI_piece,xx_piece,yy_piece]=fn_synthetic_sim_trend(csLeft,csRight)
...
[ZI]=fn_synthetic_mask_grid(ZI,xx,yy,xPolyClip,yPolyClip);
