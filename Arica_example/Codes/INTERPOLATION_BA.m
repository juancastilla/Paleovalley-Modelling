...
extract=1; %number of cross section to extract
...
for i=1:2*halfsectionPoints-1
    ...
    d=((interpolationX(1,end)-(interpolationX(i,end)))^2+(interpolationY(1,end)-(interpolationY(i,end)))^2)^0.5;
    distance(1,i)=d;
    
end

plot(distance,interpolationZ(:,end))
