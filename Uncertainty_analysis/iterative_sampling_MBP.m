...
sampling_res=100;         %density of cross section sampling of the real base surface
control_length=10;        %controls the length of sampling sections
num_repetitions=5;        %total location combinations for each number of transects
...
save('iterative_D100_R5_25_070813_IMAC','-v7.3')
